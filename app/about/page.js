    ...
    return (
        <div className="bg-[#1e103e] text-gray-300 font-sans min-h-screen flex flex-col items-center px-4">
            ...
            <div className="max-w-6xl w-full text-center mt-12">
                ...
                <h1 className="text-4xl font-bold text-[#ad4ef1] mb-8">About BoardVerse</h1>
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-semibold text-[#ad4ef1] mb-4">Our Mission</h2>
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-semibold text-[#ad4ef1] mb-4">Key Features</h2>
