  ...
  return (
    <div className="bg-[#1e103e] py-10 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        <h1 className="text-3xl font-bold text-[#ad4ef1] mb-6">Privacy Policy</h1>
        ...
        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">1. Information We Collect</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">2. How We Use Your Information</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">3. Sharing Your Information</h2>
        <p className="text-gray-300 mb-4">
          Your information is not sold or shared with third parties.
        </p>

        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">4. Data Security</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">5. Your Rights</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">6. Changes to This Policy</h2>
        <p className="text-gray-300 mb-4">
          We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated revision date.
        </p>

        <h2 className="text-2xl font-semibold text-[#ad4ef1] mt-6 mb-4">7. Contact Us</h2>
